<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fa s fa-phone-alt text-warning mr-1"></i>+91 86199 47931</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-warning mr-1"></i>gouravsinghc2003@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/gsrealestate.jpg" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<a class="btn btn-warning d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php">Submit Peoperty</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
