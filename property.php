                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="sale bg-warning text-white">For <?php echo $row['5'];?></div>
                                        <div class="price text-warning text-capitalize">$<?php echo $row['13'];?> <span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="property_list_widget">
                            ...
                            <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                ...
                                <span class="font-14"><i class="fas fa-map-marker-alt icon-warning icon-small"></i> <?php echo $row['14'];?></span>
